...
/** Bottom bar with 2 tabs: Dashboard, Profile (same as FE – label "Dashboard" instead of "Admin"). */
...
const styles = StyleSheet.create({
    ...
    content: { flexDirection: "row", justifyContent: "space-around", alignItems: "center" },
    tabItem: { alignItems: "center", flex: 1 },
    tabText: { fontSize: 10, fontWeight: "bold", textTransform: "uppercase", marginTop: 4 },
